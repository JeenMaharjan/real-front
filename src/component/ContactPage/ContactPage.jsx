    ...
    <MetaData title="Contact Us" />
     <div className='contact-model'>
        ...
        <div className="contact-middle">
          <div className="contact-m-left">
          <div className="contact-lists">
                  <p>We're here to assist you with any queries or services you may need. Whether you're looking to buy, sell, 
                    or have any questions about our real estate offerings, don't hesitate to reach out. Our dedicated team is 
                    ready to provide the information and support you need. Contact us today to get started on your real estate 
                    journey!</p>
              </div>
              <div className="contact-lists">
              ...
              <div className="contact-lists">
                  ...
                  <h2>+977 9761655210</h2>
              </div>
              <div className="contact-lists">
                  <div className="contact-list-icon">
                    <SiGmail className='contact-icon'/>
                  </div>
                  <h2>tstrealestate1@gmail.com</h2>
              </div>
              
          </div>
        <form ref={form} onSubmit={sendEmail}>
            <h2>&bull; ᴋᴇᴇᴘ ɪɴ ᴛᴏᴜᴄʜ &bull;</h2>
            ...
            <textarea value={propertyDesc} onChange={(e) => handleDescChange(e.target.value)} name="message" ></textarea>
